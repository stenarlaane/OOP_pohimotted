...
def sort_by_most_hobbies(people_list: list) -> list:
    ...
    """
    return sorted(people_list, key=lambda person: (-len(person.hobbies), person.first_name, person.last_name))
    pass
...
def sort_people_and_hobbies(people_list: list) -> list:
    ...
    for person in people_list:
        person.hobbies.sort()
    return sorted(people_list, key=lambda person: (person.first_name, person.last_name))
    pass
